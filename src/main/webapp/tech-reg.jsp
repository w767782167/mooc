                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" method="post" id="form"
			                      class="login-form" action="/mooc/techReg">
			                        
			                    	<div class="form-group">
			                    		电子邮箱
			                    		<label class="sr-only" >电子邮箱</label>
			                        	<input type="email" name="tec-email" required="required" placeholder="电子邮箱" class="form-realname form-control" id="form-email" style="height:50px">
			                        </div>
			                        <div class="form-group">
			                        	密码
			                        	<label class="sr-only" for="form-password">密码</label>
			                        	<input type="password" name="password" required="required" placeholder="密码" class="form-password form-control" id="form-password">
			                        </div>
									 <div class="form-group">
			                        	确认密码
			                        	<label class="sr-only" for="form-repassword">密码</label>
			                        	<input type="password" name="repassword" required="required" placeholder="确认密码" class="form-password form-control" id="form-repassword">
			                        </div>
									<br>			                        			                        
