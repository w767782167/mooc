...
<head>
	...
	//delete User
		function del(Id){
			var msg="确认删除吗";
			if(confirm(msg)==true){
				location.href="/mooc/teacherController?param=del&cmd="+Id+"";
				return true;
			}
		}
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left" action="/mooc/Teacher">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="/mooc/admin/assets/img/user.png" class="img-circle" alt="Avatar"> 
							<span>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/mooc/teacherController?param=list" class="active">&nbsp;&nbsp;<i class="fa fa-tumblr"></i> <span>&nbsp;&nbsp;教师管理</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				...
				<tbody>
				<c:forEach items="${msg}"  var="list" varStatus="v_user">
					<tr>
						<td>${list.fullname }</td>
						<td><img src="${list.headimg }"></td>
						<td>${list.email}</td>
						<td>${list.password}</td>
						<td>${list.sex}</td>
						<td>${list.tuition}</td>
						<td>${list.country}</td>
						<td>${list.birthday}</td>
						<td>${list.nativeLang}</td>
						<td>${list.tel}</td>
						<td>${list.skype}</td>
						<td>${list.memberType}</td>
						<td ><textarea rows="" cols="" style="width: 200px; height: 50px;">${list.introduction }</textarea>  </td>
