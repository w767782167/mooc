	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.jsp">
					...
					<!-- <img src="../style/images/lafite.png" style="height: 20px" > -->
				</a>
			</div>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<c:if test="${sessionScope.root_in_session == null}">
								<script>window.location.href="/mooc/admin/login.jsp"</script>
							</c:if>
							<c:if test="${sessionScope.root_in_session != null}">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="/mooc/admin/index.jsp" class="active"><i class="fa fa-paper-plane-o"></i> <span>&nbsp;&nbsp;主页</span></a></li>
